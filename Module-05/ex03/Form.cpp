...
/*   Updated: 2021/03/08 16:52:59 by rbraaksm      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(Form const &cpy) : _signed(cpy.getSigned()), _name(cpy.getName()), _gradeExec(cpy.getGradeExec()), _gradeSign(cpy.getGradeSign()){
	std::cout << "Form copy constructor called" << std::endl;
	*this = cpy;
	return ;
}

Form&	Form::operator=(Form const &nw){
...
void	Form::beSigned(Bureaucrat const &nw){
...
const char* Form::GradeTooHighException::what() const throw(){
	return ("Sorry, the bureaucrats grade is too high!");
}

const char* Form::GradeTooLowException::what() const throw(){
	return ("Sorry, the bureaucrats grade is too low!!");
}

const char* Form::notSigned::what() const throw(){
	return ("Make sure the form is signed before trying to execute!");
}
